...
class Address extends EWSObject
{
    public static $countries = [
      ...
      "AX" => ['alpha2' => 'AX', 'alpha3' => 'ALA', "name" => "Aland Islands",],
      ...
      "BQ" => ['alpha2' => 'BQ', 'alpha3' => 'BES', "name" => "Bonaire St Eustatius and Saba",],
      ...
      "VG" => ['alpha2' => 'VG', 'alpha3' => 'VGB', "name" => "British Virgin Islands",],
      ...
      "CW" => ['alpha2' => 'CW', 'alpha3' => 'CUW', "name" => "Curacao",],
      "CY" => ['alpha2' => 'CY', 'alpha3' => 'CYP', "name" => "Cyprus",],
      "CZ" => ['alpha2' => 'CZ', 'alpha3' => 'CZE', "name" => "Czech Republic",],
      "CD" => ['alpha2' => 'CD', 'alpha3' => 'COD', "name" => "Democratic Republic of Congo",],
      ...
      "FK" => ['alpha2' => 'FK', 'alpha3' => 'FLK', "name" => "Falkland Islands",],
      "FO" => ['alpha2' => 'FO', 'alpha3' => 'FRO', "name" => "Faroe Islands",],
      "FM" => ['alpha2' => 'FM', 'alpha3' => 'FSM', "name" => "Federated States of Micronesia",],
      ...
      "VA" => ['alpha2' => 'VA', 'alpha3' => 'VAT', "name" => "Holy See",],
      ...
      "KP" => ['alpha2' => 'KP', 'alpha3' => 'PRK', "name" => "Korea DPR",],
      "KR" => ['alpha2' => 'KR', 'alpha3' => 'KOR', "name" => "Korea Republic of",],
      "KW" => ['alpha2' => 'KW', 'alpha3' => 'KWT', "name" => "Kuwait",],
      "KG" => ['alpha2' => 'KG', 'alpha3' => 'KGZ', "name" => "Kyrgyzstan",],
      "LA" => ['alpha2' => 'LA', 'alpha3' => 'LAO', "name" => "Lao PDR",],
      ...
      "PS" => ['alpha2' => 'PS', 'alpha3' => 'PSE', "name" => "Palestinian Territory Occupied",],
      ...
      "SX" => ['alpha2' => 'SX', 'alpha3' => 'SXM', "name" => "Sint Maarten",],
      ...
      "SH" => ['alpha2' => 'SH', 'alpha3' => 'SHN', "name" => "St Helena Ascension Tristan DC",],
      "VC" => ['alpha2' => 'VC', 'alpha3' => 'VCT', "name" => "St Vincent and the Grenadines",],
      ...
      "VI" => ['alpha2' => 'VI', 'alpha3' => 'VIR', "name" => "US Virgin Islands",],
